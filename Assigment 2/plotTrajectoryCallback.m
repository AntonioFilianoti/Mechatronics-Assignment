...
% =========================================================================
% PLOTTRAJECTORYCALLBACK
% -------------------------------------------------------------------------
% Scopo:
%   Callback grafica per fmincon.
%   Mostra in tempo reale l’evoluzione della traiettoria, dei controlli
%   e del costo durante le iterazioni dell’ottimizzazione.
%
% Input:
%   x            - vettore decisionale corrente (z)
%   optimValues  - struttura interna di fmincon (contiene fval, iteration, ecc.)
%   state        - stato dell’ottimizzazione ('init', 'iter', 'done')
%
% Output:
%   stop         - booleano (true = interrompe fmincon, qui sempre false)
%
% Note:
%   Utilizza variabili globali per accedere ai parametri del problema e
%   mantenere lo storico del costo.
% =========================================================================
...
switch state
    ...
    case 'done'
        % Messaggio finale dopo la convergenza
        figure(FigTraj);
